...
namespace SIRH.Migrations
{
    public partial class intial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Candidate_DrivingLicence_DrivingLicenceId",
                        column: x => x.DrivingLicenceId,
                        principalTable: "DrivingLicence",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Candidate_SalaryWish_SalaryWishId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidate_DrivingLicenceId",
                table: "Candidate",
                column: "DrivingLicenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Candidate_SalaryWishId",
                table: "Candidate",
                column: "SalaryWishId");
